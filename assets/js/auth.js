...
if (changePhoto) {
    changePhoto.addEventListener("click", (e) => {
        ...
        var url = prompt("UI still a work in progress; paste the url set you new profile picture or enter the short tag for a profile picture if you need help tap the Help button bellow :");
        console.log("URL: [" + url + "]")
        if (url) {
            if (url == "de") {
